...
def prepare_data(df: DataFrame, assembler) -> DataFrame:
    ...
    df.withColumn("married", df.married.cast(IntegerType()))
    return assembler.transform(df)


def vector_assembler() -> VectorAssembler:
    features = ['age','sex_index','married','salary','successfully_credit_completed','credit_completed_amount','active_credits','active_credits_amount','credit_amount']
